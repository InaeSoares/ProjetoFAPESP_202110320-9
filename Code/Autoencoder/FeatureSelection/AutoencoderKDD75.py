...
dataframe1 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/400kdd75chi2.csv", header=None)
dataframe2 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/400kdd75ig.csv", header=None)
print("loaded400\n")
dataframe3 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/800kdd75chi2.csv", header=None)
dataframe4 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/800kdd75ig.csv", header=None)
print("loaded800\n")
dataframe5 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/1300kdd75chi2.csv", header=None)
dataframe6 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/1300kdd75ig.csv", header=None)
print("loaded1300\n")
dataframe7 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/5000kdd75chi2.csv", header=None)
dataframe8 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/5000kdd75ig.csv", header=None)
print("loaded5000\n")
    ...
    class AnomalyDetector(Model):
      def __init__(self):
        ...
        self.encoder = tf.keras.Sequential([
          layers.Dense(29, activation="relu"), # 34 p/ 10 camadas
          layers.Dense(25, activation="relu"), # 30 p/ 10 camadas
          layers.Dense(20, activation="relu"), # 26 p/ 10 camadas
          layers.Dense(17, activation="relu"), # 22 p/ 10 camadas
          layers.Dense(14, activation="relu"), # 18 p/ 10 camadas
          layers.Dense(11, activation="relu"), # 14 p/ 10 camadas
          layers.Dense(9, activation="relu"), # 10 p/ 10 camadas
        ...
        self.decoder = tf.keras.Sequential([
          ...
          layers.Dense(25, activation="relu"), # 30 p/ 10 camadas
          layers.Dense(29, activation="relu"), # 34 p/ 10 camadas
          layers.Dense(31, activation="relu"), #41 p/ 10 camadas
          ])
...
df.to_csv(r"C:/Users/Administrator/Downloads/ICInae/DAWOUD/Autoencoder/KDDFeatureSelectionPreds75.csv",index=False) 