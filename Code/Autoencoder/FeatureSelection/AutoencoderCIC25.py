...
dataframe1 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/CICAWS/FeatureSelection/400cic25chi2.csv", header=None)
dataframe2 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/CICAWS/FeatureSelection/400cic25ig.csv", header=None)
print("loaded400\n")
dataframe3 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/CICAWS/FeatureSelection/800cic25chi2.csv", header=None)
dataframe4 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/CICAWS/FeatureSelection/800cic25ig.csv", header=None)
print("loaded800\n")
dataframe5 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/CICAWS/FeatureSelection/1300cic25chi2.csv", header=None)
dataframe6 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/CICAWS/FeatureSelection/1300cic25ig.csv", header=None)
print("loaded1300\n")
dataframe7 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/CICAWS/FeatureSelection/5000cic25chi2.csv", header=None)
dataframe8 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/CICAWS/FeatureSelection/5000cic25ig.csv", header=None)
print("loaded5000\n")
...
df.to_csv(r"C:/Users/Administrator/Downloads/ICInae/DAWOUD/Autoencoder/CICFeatureSelectionPreds25.csv",index=False)
