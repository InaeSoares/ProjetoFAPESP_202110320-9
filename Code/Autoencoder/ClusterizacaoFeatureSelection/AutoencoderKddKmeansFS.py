...
dataframe1 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/kdd400FSKmeans.csv", header=None)
print("loaded400\n")
dataframe2 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/kdd800FSKmeans.csv", header=None)
print("loaded800\n")
dataframe3 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/kdd1300FSKmeans.csv", header=None)
print("loaded1300\n")
dataframe4 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/Datasets/KDD99/Binary/FeatureSelection/kdd5000FSKmeans.csv", header=None)
print("loaded5000\n")
    ...
    class AnomalyDetector(Model):
      def __init__(self):
        ...
        self.decoder = tf.keras.Sequential([
          layers.Dense(4, activation="relu"), # 4 p/ 10 camadas
          layers.Dense(7, activation="relu"), # 8 p/ 10 camadas 
          layers.Dense(11, activation="relu"), # 10 p/ 10 camadas
          ])
...
df.to_csv(r"C:/Users/Administrator/Downloads/ICInae/DAWOUD/Autoencoder/KddPredFSKmeans.csv",index=False) 