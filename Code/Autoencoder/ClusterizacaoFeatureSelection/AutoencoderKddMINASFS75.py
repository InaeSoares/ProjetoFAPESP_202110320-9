...
dataframe1 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/DAWOUD/MINAS/MINASkdd400FS.csv", header=None)
print("loaded400\n")
dataframe2 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/DAWOUD/MINAS/MINASkdd800FS.csv", header=None)
print("loaded800\n")
dataframe3 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/DAWOUD/MINAS/MINASkdd1300FS.csv", header=None)
print("loaded1300\n")
dataframe4 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/DAWOUD/MINAS/MINASkdd5000FS.csv", header=None)
print("loaded5000\n")
...
df.to_csv(r"C:/Users/Administrator/Downloads/ICInae/DAWOUD/Autoencoder/KddPredMINASFS75.csv",index=False) 