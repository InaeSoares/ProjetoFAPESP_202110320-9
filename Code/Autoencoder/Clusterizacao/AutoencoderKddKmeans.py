...
dataframe1 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/DAWOUD/Autoencoder/400kddKmeansF.csv", header=None)
print("loaded400\n")
dataframe2 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/DAWOUD/Autoencoder/800kddKmeansF.csv", header=None)
print("loaded800\n")
dataframe3 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/DAWOUD/Autoencoder/1300kddKmeansF.csv", header=None)
print("loaded1300\n")
dataframe4 = pd.read_csv("C:/Users/Administrator/Downloads/ICInae/DAWOUD/Autoencoder/5000kddKmeansF.csv", header=None)
print("loaded5000\n")
...
for x in range(4):
  ...
  for y in range(10):
    ...
    #PLOTAR GRÁFICOS COM OS DADOS NORMAIS E ANORMAIS

    plt.grid()
    plt.plot(np.arange(42), normal_train_data[0]) 
    plt.title("dados normais")
    plt.savefig("dadosNormais"+str(x)+str(y))
  
    plt.grid()
    plt.plot(np.arange(42), anomalous_train_data[0]) 
    plt.title("dados anormais")
    plt.savefig("dadosAnormais"+str(x)+str(y))
    ...
    class AnomalyDetector(Model):
      def __init__(self):
        ...
        self.decoder = tf.keras.Sequential([
          ...
          layers.Dense(42, activation="relu"), #41 p/ 10 camadas
          ])
...
df.to_csv(r"C:/Users/Administrator/Downloads/ICInae/DAWOUD/Autoencoder/KddPredKmeans1.csv",index=False) 